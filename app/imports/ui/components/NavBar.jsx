    ...
    return (
      <Menu style={menuStyle} attached="top" borderless inverted>
        ...
        {Roles.userIsInRole(Meteor.userId(), 'siteAdmin') ? (
          [<Menu.Item as={NavLink} activeClassName="active" exact to="/admin" key='admin'>Manage Clubs (Admin)</Menu.Item>, <Menu.Item as={NavLink} activeClassName="active" exact to="/add" key='add'>Create Clubs</Menu.Item>]
        ) : ''}
